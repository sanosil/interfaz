...
class User_menu():
    ...
    def create_widgets(self):
        ...
        self.nombre_usuario = Label(self.frm_campos_usuario, bg="white",
                        text=self.root.usernames[self.current_user],
                        font=self.root.myFont)
    ...
    def cambiar_imagen_usuario(self, event, direccion):
        ...
        self.imagen_usuario_actual.config(
                            image=self.user_images[self.current_user])
    ...
    def cambiar_username(self):
        self.root.teclado = teclado.Teclado(self.root, "Cambiar nombre de usuario", self.root.usernames[self.current_user], 1)
